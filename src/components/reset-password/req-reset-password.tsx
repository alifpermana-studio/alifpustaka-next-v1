...
export const RequestResetPassword = () => {
  ...
  const sendResetPasswordEmail = useCallback(async (e: string) => {
    setIsLoading(true);
    setError(null);
  ...
  return (
    <div className="relative flex min-h-screen w-full items-stretch overflow-hidden bg-[#060912]">
      ...
      />
      <div className="relative z-10 mt-10 flex w-full flex-col items-center justify-center gap-8 p-12">
        <div className="animate-in hidden max-w-2xl items-center justify-center gap-4 lg:flex">
          <p className="text-center text-2xl">
            Please provide your email to reset password. We will send you link
            to perform reset password.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-lg leading-relaxed text-slate-400">
            Please reset your password using the link that was sent to you.
          </p>
          <p className="text-lg leading-relaxed text-slate-400">
